...
export default function PreferencesTab({ profile, onRefresh }) {
  ...
  return (
    <div className="candidate-preferences-tab space-y-6">
      <div>
        <h2 className="font-display text-xl font-bold text-[#214740] dark:text-[#214740]">Preferences &amp; Privacy</h2>
        <p className="text-sm text-[#5A7B71] dark:text-[#5A7B71]">
      ...
      <form onSubmit={handleSave} className="space-y-5">
        {/* Availability */}
        <div className="rounded-2xl border border-[#D2ECC9] bg-white p-5 shadow-xs dark:border-[#D2ECC9] dark:bg-white">
          <label className="block font-display text-base font-bold text-[#214740] dark:text-[#214740]">
          ...
          <select
            ...
            className="mt-3 w-full max-w-xs rounded-xl border border-[#D2ECC9] bg-[#FBFBFD] px-3.5 py-2.5 text-sm font-bold text-[#214740] dark:border-[#D2ECC9] dark:bg-[#FBFBFD] dark:text-[#214740]"
          >
        ...
        <div className="rounded-2xl border border-[#D2ECC9] bg-white p-5 shadow-xs dark:border-[#D2ECC9] dark:bg-white">
          <h3 className="font-display text-base font-bold text-[#214740] dark:text-[#214740]">Communication Channels</h3>
          <div className="mt-3 space-y-3 divide-y divide-[#EAF9E1] text-sm dark:divide-[#EAF9E1]">
            <label className="flex items-center justify-between pt-2 cursor-pointer">
              <div>
                <p className="font-bold text-[#214740] dark:text-[#214740]">Recommended Job Alerts</p>
                <p className="text-[#5A7B71]">Receive weekly emails with roles matching your resume version skills.</p>
              </div>
              <input
                type="checkbox"
                checked={preferences.jobAlerts}
                onChange={() => handleToggle("jobAlerts")}
                className="h-4 w-4 rounded text-brand-800 accent-[#214740] dark:accent-[#214740]"
              />
            </label>

            <label className="flex items-center justify-between pt-3 cursor-pointer">
              <div>
                <p className="font-bold text-[#214740] dark:text-[#214740]">WhatsApp Interview Reminders</p>
                <p className="text-[#5A7B71]">Get timely reminders before AI interviews and assessment deadlines.</p>
              </div>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between pt-3 cursor-pointer">
              <div>
                <p className="font-bold text-[#214740] dark:text-[#214740]">SMS Notifications</p>
                <p className="text-[#5A7B71]">Critical stage alerts sent to your verified mobile number.</p>
              </div>
              <input
                type="checkbox"
      ...
      <section className="rounded-3xl border border-[#2E4F48] bg-[#214740] p-6 text-white shadow-soft">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <Button
            ...
            disabled={exporting}
            className="shrink-0 bg-white text-[#214740] hover:bg-[#EAF9E1] font-bold"
          >
            {exporting ? (
              <>
