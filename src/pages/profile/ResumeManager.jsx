...
export default function ResumeManager() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-[#E2E8F0] bg-white p-6 shadow-soft dark:border-[#E2E8F0] dark:bg-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#F4F6F9]-deep/80 p-4 backdrop-blur-xs">
          <div className="w-full max-w-lg rounded-3xl border border-[#E2E8F0] bg-white p-6 shadow-lift">
            ...
            <div className="mt-4 space-y-4">
              <div>
                <label className="block text-xs font-bold text-[#0F172A]">Version Label</label>
                <input
                  type="text"
                  value={customLabel}
                  onChange={(e) => setCustomLabel(e.target.value)}
                  className="mt-1 w-full rounded-xl border border-[#E2E8F0] bg-[#F4F6F9] px-3 py-2 text-sm text-[#0F172A]"
                  placeholder="e.g. Clinical_Psychology_v2.pdf"
                />
              </div>

              <div>
                <label className="block text-xs font-bold text-[#0F172A]">Target Role Tags</label>
