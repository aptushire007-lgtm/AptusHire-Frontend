    ...
    <div className={`flex gap-2.5 ${isAi ? "" : "flex-row-reverse"}`}>
      <div
        ...
        className={
          ...
          (isAi ? "bg-brand-100 text-primary" : "bg-slate-200 text-slate-600")
        }
      >
      ...
      <div
        className={
          ...
          (isAi ? "bg-white text-slate-700 shadow-card" : "bg-primary text-white") +
          (muted ? " opacity-70" : "")
        }
      >
  ...
  if (!state) {
    ...
    <div className="space-y-4">
      ...
      {fullscreenLost && (
        <div
          role="alert"
          className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-brand-200 bg-brand-50 px-3 py-2 text-sm font-medium text-primary"
        >
      ...
      {warning && (
        <div
          role="alert"
          className="flex items-center gap-2 rounded-lg border border-brand-200 bg-brand-50 px-3 py-2 text-sm font-medium text-primary"
        >
      ...
      <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1">
        ...
        <span className="rounded-full bg-brand-100 px-3.5 py-1.5 text-sm font-semibold text-primary">
              ...
              !started ? (
                <div className="flex flex-col items-center gap-3 py-2 text-center">
                  ...
                  <button
                    ...
                    className="tap-target rounded py-1 text-xs font-medium text-text-muted hover:text-text focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-100"
                  >
                    ...
                    {phase === "listening" && !backchannel && (
                      <p
                        className={`flex items-center gap-2 text-sm font-medium ${
                          endingSoon ? "text-primary" : "text-emerald-700"
                        }`}
                      >
                        <span className="relative flex h-2.5 w-2.5">
                          <span
                  ...
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5">
                    ...
                    {supported && (
                      <button
                        ...
                        className="tap-target rounded py-1 text-xs font-medium text-brand-600 hover:text-primary focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-100"
                      >
              ...
              {endingSoon ? (
                <>
                  ...
                  <button
                    ...
                    className="tap-target rounded-full border border-slate-300 px-2.5 py-0.5 text-xs font-semibold text-slate-700 hover:border-brand-400 hover:text-primary"
                  >
                    I'm still thinking
                  </button>
                </>
            ...
            <div>
              ...
              <div className="mt-1.5 flex items-center gap-3 pl-11 text-xs">
                ...
                <button
                  ...
                  className="tap-target flex items-center gap-1 rounded py-1 font-semibold text-brand-600 hover:text-primary focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-100"
                >
