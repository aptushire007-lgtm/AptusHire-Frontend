...
const STATUS_STYLE = {
  current: { chip: "bg-[#FF6B2C] text-white ring-brand-600", dot: "bg-[#FF6B2C]", label: "Current question" },
...
export default function AssessmentRoom() {
  ...
  return (
    <div className="flex h-[100dvh] flex-col overflow-hidden bg-[#F5F5F0]">
      ...
      <header className="shrink-0 border-b border-slate-200 bg-white">
        ...
        <div className="h-1 w-full bg-slate-100" role="presentation">
          <div className="h-full bg-[#FF6B2C] transition-[width] duration-300 ease-out" style={{ width: `${progressPct}%` }} />
        </div>
      </header>
      ...
      {sheetOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          <button
            ...
            className="absolute inset-0 bg-[#F5F5F0]-deep/70"
          />
          <div
            role="dialog"
            aria-modal="true"
      ...
      {timeUp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#F5F5F0]-deep/80 px-6">
          ...
          return (
            <label
              ...
              className={`flex cursor-pointer items-center gap-3 rounded-xl border p-3.5 text-sm transition-colors has-[:focus-visible]:ring-4 has-[:focus-visible]:ring-brand-100 ${
                isSelected
                  ? "border-brand-500 bg-[#FFE8DC] text-slate-900 ring-1 ring-inset ring-brand-500"
            ...
            >
              ...
              <span
                ...
                className={`flex h-8 w-8 shrink-0 items-center justify-center text-xs font-bold ${multi ? "rounded-lg" : "rounded-full"} ${
                  isSelected ? "bg-[#FF6B2C] text-white" : "bg-slate-100 text-slate-500"
                }`}
              >
