...
function CompanyLogo({ company }) {
  ...
  return (
    <div className="flex h-[72px] w-[72px] shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-[#DCE5DE] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.07)] sm:h-20 sm:w-20">
      {logo && !logoFailed ? (
...
export default function JobDetail() {
    ...
    return (
      <div className="space-y-6">
        ...
        <Card className="border-[#E2E8F0] bg-white py-12 text-center dark:border-[#E2E8F0] dark:bg-white">
          <h1 className="text-xl font-semibold text-[#0F172A]">Job unavailable</h1>
  ...
  if (!job) {
    return (
      <div className="space-y-4">
        ...
        <Card className="border-[#E2E8F0] bg-white dark:border-[#E2E8F0] dark:bg-white"><Skeleton className="h-52 w-full" /></Card>
        <Card className="border-[#E2E8F0] bg-white dark:border-[#E2E8F0] dark:bg-white"><Skeleton className="h-64 w-full" /></Card>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5 pb-10">
      ...
      <Card className="border-[#E2E8F0] bg-white dark:border-[#E2E8F0] dark:bg-white" padding="none">
      ...
      <Card className="border-[#E2E8F0] bg-white dark:border-[#E2E8F0] dark:bg-white">
        <section>
          <h2 className="text-[16px] font-semibold text-[#0F172A]">Job Description</h2>
        ...
        <section className="mt-8 border-t border-[#E5EBE6] pt-7">
          <h2 className="text-[16px] font-semibold text-[#0F172A]">Requirements</h2>
        ...
        <div className="mt-8 grid gap-4 border-t border-[#E5EBE6] pt-7 sm:grid-cols-3">
          <div><h2 className="text-[16px] font-semibold text-[#0F172A]">Salary</h2><p className="mt-2 text-[13px] text-[#64748B]">{salary || "Not provided"}</p></div>
          <div><h2 className="text-[16px] font-semibold text-[#0F172A]">Location</h2><p className="mt-2 text-[13px] text-[#64748B]">{job.location || "Not specified"}</p></div>
          <div><h2 className="text-[16px] font-semibold text-[#0F172A]">Job Type</h2><p className="mt-2 text-[13px] text-[#64748B]">{jobType}</p></div>
        </div>

        <div className="mt-8 flex flex-col gap-3 border-t border-[#E5EBE6] pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="max-w-xl text-[13px] leading-5 text-[#64748B]">
            {job.alreadyApplied
