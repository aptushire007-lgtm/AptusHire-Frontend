              ...
              <ul className="grid list-none gap-4 lg:grid-cols-2">
                {history.map((r, i) => (
                  <li
                    ...
                    className="flex h-full min-w-0 flex-col rounded-2xl border border-slate-200 bg-white p-5 transition-colors hover:border-brand-200"
                  >
                    ...
                    <div className="mt-auto flex gap-2 pt-4">
                      ...
                      <Button
                        ...
                        className="shrink-0 border-red-200 text-verdict-negative hover:border-red-300 hover:bg-red-50"
                      >
