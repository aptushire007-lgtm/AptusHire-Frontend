      ...
      <Card>
        ...
        <form onSubmit={handleUpload} className="mt-5">
          {error && (
            <p
              role="alert"
              className="mb-4 flex items-start gap-2 rounded-xl border border-red-200 bg-red-50 px-3.5 py-2.5 text-sm font-medium text-[#DC2626]"
            >
          ...
          {status === "uploaded" && (
            <p
              role="status"
              className="mb-4 flex items-start gap-2 rounded-xl border border-emerald-200 bg-[#FEF3E8] px-3.5 py-2.5 text-sm font-medium text-[#F97316]"
            >
          ...
          <FormGroup>
            ...
            <label className="flex cursor-pointer flex-col items-center gap-2 rounded-2xl border border-dashed border-slate-300 bg-[#F4F6F9] px-4 py-8 text-center text-sm text-slate-600 transition-colors hover:border-brand-400 hover:bg-[#FEF3E8]/50">
              ...
              <ul className="grid list-none gap-4 lg:grid-cols-2">
                {history.map((r, i) => (
                  <li
                    ...
                    className="flex h-full min-w-0 flex-col rounded-2xl border border-slate-200 bg-white p-5 transition-colors hover:border-[#FED7AA]"
                  >
                    ...
                    <dl className="mt-4 space-y-2 rounded-xl bg-[#F4F6F9] px-4 py-3 text-xs">
                    ...
                    <div className="mt-auto flex gap-2 pt-4">
                      ...
                      <Button
                        ...
                        className="shrink-0 border-red-200 text-[#DC2626] hover:border-red-300 hover:bg-red-50"
                      >
