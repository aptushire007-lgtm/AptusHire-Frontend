  ...
  return (
    <div className="space-y-5 pb-8 text-[#14233A]">
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-[14px] border border-[#DDE8DE] bg-[#F5FAF2] px-4 py-3 text-sm text-[#596660]">
        ...
        <span>{resume ? <>Evaluating <strong className="text-[#214740]">{resume.label || "your default CV"}</strong></> : "Add a CV to generate your evaluation"}</span>
      ...
      {analysis ? (
        <>
          ...
          <section className="rounded-[18px] border border-[#DFE5E4] bg-white p-5 shadow-[0_5px_18px_rgba(33,71,64,.06)] sm:p-6">
            <div className="mb-4 flex items-center gap-2"><FileSearch className="h-5 w-5 text-[#214740]" /><h2 className="text-[20px] font-semibold text-[#252B29]">Professional Profile Analysis</h2></div>
