...
export default function AssessmentHub() {
  ...
  if (session.status === "completed") {
    if (session.terminatedForIntegrity) {
      return (
        <Card className="py-10 text-center">
          ...
          {totals.items > 0 && (
            <p className="mt-5 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-[#F8FAF9] px-4 py-2.5 text-xs text-slate-600">
    ...
    return (
      <Card className="py-10 text-center">
        <span className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#E8F2EC] text-[#176B45]">
    ...
    <div className="space-y-5">
      <Card>
        ...
        <dl className="mt-5 grid gap-3 border-t border-slate-100 pt-5 sm:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-[#F8FAF9] px-4 py-3">
