    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <div className="mt-6 grid gap-3 border-t border-slate-100 pt-6 text-sm">
          ...
          <p className="flex items-start gap-2.5 rounded-xl border border-slate-200 bg-[#F4F6F9] px-4 py-3 text-slate-600">
        ...
        <div className="mt-6">
          ...
          {session.status === "in_progress" && (
            <div className="space-y-3">
              <p className="flex items-start gap-2.5 rounded-xl border border-emerald-200 bg-[#FEF3E8] px-4 py-3 text-sm font-medium text-[#F97316]">
          ...
          {session.status === "completed" && (
            <div className="rounded-2xl border border-emerald-200 bg-[#FEF3E8] p-5 text-sm text-slate-700">
              <p className="flex items-center gap-2 font-semibold text-[#F97316]">
          ...
          {(session.status === "expired" || session.status === "cancelled") && (
            <p className="flex items-start gap-2.5 rounded-2xl border border-red-200 bg-red-50 p-4 text-sm font-medium text-[#DC2626]">
